 ...
 *   to [VisualizationRepository]. The UseCase has no filter logic, it then deletes the userIDs list
...
class DeleteUsersAccessToVisualizationUCTest {
    ...
    @Test
    fun `return failure when both visualizationID and userIDs is invalid`() = runTest {
        // Given
        val visualizationID = ""
        val userIDs = listOf("1", "2", "3")
