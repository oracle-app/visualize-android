...
object FirebaseModule {
    ...
    @Provides
    @Singleton
    fun provideAuthFirebaseSource(auth: FirebaseAuth): AuthFirebaseSource = AuthFirebaseSource(auth)
    ...
    @Provides
    @Singleton
    fun provideVisualizationDataSource(db: FirebaseFirestore): VisualizationDataSource = VisualizationDataSource(db)
...
abstract class RepositoryModule {
    ...
    @Binds
    @Singleton
    abstract fun bindVisualizationRepository(impl: VisualizationRepositoryImpl): VisualizationRepository
